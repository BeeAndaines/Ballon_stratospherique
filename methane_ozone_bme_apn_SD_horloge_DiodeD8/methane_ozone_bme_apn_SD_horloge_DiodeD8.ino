 ...
 * sans diode de roue libre pour l'app photo, ce n'est pas un moteur que l 'on déclenche
 */
int pinMoteur=7;
...
delay(1000);
 digitalWrite(D8, HIGH);
    delay(1000);
digitalWrite(D8, LOW);
// si le carte est détectée_ la diode D8 clignote 2fois
...
// on enregistre sur SD année; mois; jour; heure; minute; seconde; ozone ; methane ; P ; H ; T ; z
//Zone SD
